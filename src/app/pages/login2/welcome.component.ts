...
export class NzDemoTableEditCellComponent implements OnInit {
  ...
  private reqSuccess = false;
  private reqSuccessMsg = '';
  private url = 'http://localhost:8080/api/coins/git/log/findReceivedGift';
  constructor(private httpRequestService : HttpRequestService) {
  }
  onSubmit(){
    this.httpRequestService.httpPost(this.url,{"testing":"1", "relatedId":"2","page":"1","limit":"10"},this,1);
  }
  postOk (val, flag){
...
//https://blog.csdn.net/dailuwen/article/details/79375980
